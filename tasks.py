...
class SAPT(FiretaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        client = MongoClient("mongodb+srv://vijay:B3AC6480dVoLFDeb@saptfireworkscluster.mpqjgq8.mongodb.net/saptenergydb?reWrites=true")
        db = client["saptenergydb"]
        collection = db["saptenergydb"]
